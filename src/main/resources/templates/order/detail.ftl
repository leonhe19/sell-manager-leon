                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                    <form action="/order/list" method="GET" id="signupForm">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">
                                                下次支付时间:</label>
                                                <div class="col-sm-10">
                                                    <div class="col-sm-10"><input type="text" class="form-control"  name="nextPayTime" value="${order.nextPayTime?if_exists}"></div>
                                                </div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">
                                                回扣:</label>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="col-sm-10">
                                                        <#if order.productState==0>
                                                            <input type="text"  name="productState"  class="form-control"  value="未发货">
                                                        <#elseif order.productState==1>
<input type="text"    name="productState"   class="form-control"  value="发货部分">
                                                        <#else>
<input type="text"   name="productState"   class="form-control"  value="发货完成">
                                                        </#if>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="col-sm-10">
                                                        <#if order.payState==0>
                                                            <input type="text"  name="payState" class="form-control"  value="未支付">
                                                        <#elseif order.payState==1>
<input type="text"  name="payState" class="form-control"  value="支付部分">
                                                        <#else>
<input type="text"  name="payState" class="form-control"  value="支付完成">
                                                        </#if>
                                                    </div>
                                                </div>
                                            </div>
